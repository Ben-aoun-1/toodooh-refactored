/*
  # Fonction RPC pour créer des profils business

  1. Problème
    - Les politiques RLS empêchent la création de profils lors de l'inscription
    - Besoin d'une fonction sécurisée pour contourner ce problème

  2. Solution
    - Créer une fonction RPC avec SECURITY DEFINER
    - Permettre la création de profils pour les nouveaux utilisateurs
    - Validation des données d'entrée
*/

-- Fonction pour créer un profil business
...
-- Fonction simplifiée pour créer un profil par défaut
