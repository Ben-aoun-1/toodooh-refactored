...
export default function GiftCatalogPage() {
  ...
  const categories = [
    ...
    { id: 'electronics', name: 'Électronique', count: giftItems.filter(item => item.category === 'electronics').length },
    { id: 'vouchers', name: 'Cartes cadeaux', count: giftItems.filter(item => item.category === 'vouchers').length },
    { id: 'experiences', name: 'Expériences', count: giftItems.filter(item => item.category === 'experiences').length },
    { id: 'gadgets', name: 'Gadgets', count: giftItems.filter(item => item.category === 'gadgets').length }
  ];
                ...
                <div className="flex items-center space-x-4">
                  <div className="bg-white rounded-xl px-4 py-2 border border-gray-200 shadow-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-900 font-semibold">{userPoints.toLocaleString()}</span>
