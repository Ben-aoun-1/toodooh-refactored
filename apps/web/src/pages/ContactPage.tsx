  ...
  const faqItems = [
    {
      ...
      answer: 'Accédez à la section "Mes Écrans" et cliquez sur "Ajouter un Écran". Remplissez les informations requises et validez.'
    },
    {
      question: 'Comment déclarer une indisponibilité ?',
      answer: 'Dans le tableau de bord, utilisez l\'action rapide "Déclarer Indisponibilité" ou accédez au calendrier d\'indisponibilités.'
    },
    {
      question: 'Comment consulter mes revenus ?',
      answer: 'La section "Revenus" vous donne accès à toutes vos statistiques financières et graphiques de performance.'
    },
    {
      question: 'Comment échanger mes points fidélité ?',
      answer: 'Accédez au "Catalogue Cadeaux" et choisissez parmi les récompenses disponibles selon vos points.'
    }
  ];
                  ...
                  <div className="space-y-3">
                    {faqItems.map((item, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-3">
                        <h4 className="text-gray-900 font-medium text-sm mb-1">{item.question}</h4>
