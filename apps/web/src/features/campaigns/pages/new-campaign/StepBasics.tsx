...
/**
 * Basics step of the de-Supabase wizard: campaign name + diffusion period. Leaving this step is what
 * creates the draft (POST /api/campaigns), so the parent's `onNext` is async and `creating` guards
 * the button. Owns its own name/date field-error UX.
 */
export default function StepBasics({
  ...
  const nextDisabled =
    creating || !campaignName.trim() || !startDate || !endDate || startDate >= endDate;
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Nommez votre campagne et choisissez sa période</p>
        </div>
