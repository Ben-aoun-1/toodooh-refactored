 ...
 * Piste 02 stays AI-authored (unchanged contract). The titles survive the supersession.
 *
...
// ── Piste 02 — l'angle mort (AI-authored, contract unchanged) ─────────────────────────────────
...
export interface PistesInput {
  ...
  sps: SpsBlock | null;
  /** The cached AI body for Piste 02; null/blank → the generic angles-morts body. */
  aiBody: string | null;
}
